...
function elevar(num, exponent) {
  ...
  // Tu código:
  var numeros = Math.pow(num, exponent); 
  return numeros;
}
...
function numeroRandom() {
  ...
  var numeroGenerado = Math.random(); 
...
function esPositivo(numero) {
  ...
  var numeroRecibido = Math.sign(numero);
  if(numeroRecibido === 1){
    return "Es positivo"; 
...
function areaDelTriangulo(base, altura){
  ...
  //Escribe tu código aquí
  var dataRecibida = base * altura; 
  return dataRecibida / 2;
}
...
function deEuroAdolar(euro){
  ...
  //Escribe tu código aquí
  var diferenciaDinero = euro * 0.20; 
  var cambioEnDolares =  diferenciaDinero + euro; 
